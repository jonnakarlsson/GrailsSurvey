			...
			<tbody>
				<g:form action="createQuestion">
					<tr>
						...
						<td class="QuestionText2"><input type="text"
							name="newQuestion" id="question" class="questionInput"
							placeholder="Ny fråga"></td>
						<td><select name="questionType">
								<option value="1">BETYG</option>
								<option value="2">JA/NEJ</option>
								<option value="3">TEXT</option>
						</select></td>
						<td><input type="checkbox" name="enabled" value="true"
							checked></td>
